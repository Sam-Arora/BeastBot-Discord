...
from beastbot import VersionInfo

from beastbot.core import data_manager
from beastbot.core.utils.chat_formatting import box

if TYPE_CHECKING:
    from beastbot.core.bot import Red
    from beastbot.core.commands import Command, Context
...
async def fuzzy_command_search(
    ...
    *,
    ...
    Returns
    -------
    Optional[List[`commands.Command <beastbot.core.commands.Command>`]]
