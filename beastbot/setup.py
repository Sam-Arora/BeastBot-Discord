...
from beastbot.core.cli import confirm
from beastbot.core.utils._internal_utils import safe_delete, create_backup as red_create_backup
from beastbot.core import config, data_manager, drivers
from beastbot.core.drivers import BackendType, IdentifierData

conversion_log = logging.getLogger("red.converter")

config_dir = None
appdir = appdirs.AppDirs("Red-DiscordBot")
#print(appdir.user_config_dir)
...
def basic_setup():
    ...
    print()
    print(
        "Your basic configuration has been saved. Please run `beastbot <name>` to"
