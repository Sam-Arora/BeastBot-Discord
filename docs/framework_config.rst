...
.. py:currentmodule:: beastbot.core.config
...
.. code-block:: python
    ...
    from beastbot.core import Config, commands
...
.. code-block:: python
    ...
    from beastbot.core import Config, commands, checks
...
the built-in Economy credits::
    ...
    from beastbot.core import bank
    from beastbot.core import Config, commands
...
.. automodule:: beastbot.core.config
...
.. autofunction:: beastbot.core.drivers.get_driver

.. autoclass:: beastbot.core.drivers.BackendType
    :members:

.. autoclass:: beastbot.core.drivers.ConfigCategory
    :members:

Base Driver
^^^^^^^^^^^
.. autoclass:: beastbot.core.drivers.BaseDriver
    :members:

JSON Driver
^^^^^^^^^^^
.. autoclass:: beastbot.core.drivers.JsonDriver
    :members:

Postgres Driver
^^^^^^^^^^^^^^^
.. autoclass:: beastbot.core.drivers.PostgresDriver
    :members:
