...
import discord
from beastbot.core import checks, commands, Config, version_info as red_version_info
from beastbot.core.bot import Red
from beastbot.core.data_manager import cog_data_path
from beastbot.core.i18n import Translator, cog_i18n
from beastbot.core.utils.chat_formatting import box, pagify, humanize_list, inline
    ...
    async def findcog(self, ctx: commands.Context, command_name: str) -> None:
        ...
        **Arguments**
        ...
        if cog:
            ...
            elif cog.__module__.startswith("beastbot."):  # core commands or core cog
