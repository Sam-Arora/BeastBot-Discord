...
from beastbot.cogs.warnings.helpers import (
    warning_points_add_check,
    get_command_for_exceeded_points,
    get_command_for_dropping_points,
    warning_points_remove_check,
)
from beastbot.core import Config, checks, commands, modlog
from beastbot.core.bot import Red
from beastbot.core.commands import UserInputOptional
from beastbot.core.i18n import Translator, cog_i18n
from beastbot.core.utils import AsyncIter
from beastbot.core.utils.chat_formatting import warning, pagify
from beastbot.core.utils.menus import menu, DEFAULT_CONTROLS
