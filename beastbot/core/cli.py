...
def parse_cli_flags(args):
    parser = argparse.ArgumentParser(
        description="Red - Discord Bot", usage="beastbot <instance_name> [arguments]"
    )
    ...
    parser.add_argument(
        "--list-instances",
        action="store_true",
        help="List all instance names setup with 'beastbot-setup'",
    )
    parser.add_argument(
        "--edit",
        action="store_true",
    ...
    parser.add_argument(
        "instance_name", nargs="?", help="Name of the bot instance created during `beastbot-setup`."
    )
    parser.add_argument(
