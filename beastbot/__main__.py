...
from beastbot import _update_event_loop_policy, __version__

_update_event_loop_policy()

import beastbot.logback
from beastbot.core.bot import Red, ExitCodes
from beastbot.core.cli import interactive_config, confirm, parse_cli_flags
from beastbot.setup import get_data_dir, get_name, save_config
from beastbot.core import data_manager, drivers
from beastbot.core._sharedlibdeprecation import SharedLibImportWarner
...
def list_instances():
    if not data_manager.config_file.exists():
        print(
            ...
            "using `beastbot-setup` before trying to run the bot!"
        )
        sys.exit(1)
    else:
